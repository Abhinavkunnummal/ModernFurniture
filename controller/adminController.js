...
const addingNewProduct = async (req, res) => {
  try {
    ...
    const product = new Product({ name, description, price, category: categoryId._id, stock, image: croppedimages, dateCreated: new Date() });
    await product.save();
...
module.exports = addingNewProduct;
